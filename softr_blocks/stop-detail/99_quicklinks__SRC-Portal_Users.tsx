        ...
        <CardContent className="pt-0">
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }}>
            <Row
              ...
              chipBg="rgba(0,233,239,0.12)"
              chipBorder="rgba(0,233,239,0.22)"
              iconColor="rgba(0,233,239,0.96)"
            />
            <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }} />
            ...
            <Row
              ...
              iconColor="rgba(251,191,36,0.92)"
            />
            <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }} />
            ...
            <Row
              ...
              iconColor="rgba(229,231,235,0.90)"
            />
            <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }} />
            ...
            <Row
              ...
              chipBg="rgba(0,233,239,0.08)"
              chipBorder="rgba(0,233,239,0.18)"
              iconColor="rgba(0,233,239,0.86)"
            />
            <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }} />
