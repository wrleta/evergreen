...
export default function Block(props: any) {
  ...
  const routes = {
    ...
    userUpdateRequestsDetail: "/user-update-requests", // Portal_User_Update_Requests details
        ...
        <main className="mx-auto w-full max-w-5xl px-4 sm:px-6 py-10">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <div className="mt-5 text-sm" style={{ color: "rgba(229,231,235,0.75)" }}>
              Please log in to view user update requests.
            </div>
      ...
      >
        ...
        <div className="space-y-2">
          <div className="flex items-end justify-between gap-3">
            <div className="min-w-0">
              <div className="text-2xl font-extrabold leading-tight truncate text-white">User Update Requests</div>
              <div className="text-sm font-semibold" style={{ color: "rgba(229,231,235,0.72)" }}>
                Roster / profile corrections (name, phone, crew, role, language)
              </div>

              {debug ? (
                <div className="mt-2 text-xs" style={{ color: "rgba(229,231,235,0.60)" }}>
                  debug: logged-in email = {userEmail || "(none)"}
                </div>
              ) : null}
            </div>
            ...
            <div
              ...
              title={displayName}
            >
              <User className="w-5 h-5" style={{ color: "rgba(0,233,239,0.95)" }} />
            </div>
          </div>
